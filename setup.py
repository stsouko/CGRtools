...
setup(
    name='CGRtools',
    version='4.2.22',
    packages=['CGRtools', 'CGRtools.algorithms', 'CGRtools.algorithms.aromatics', 'CGRtools.algorithms.calculate2d',
              'CGRtools.algorithms.components', 'CGRtools.algorithms.standardize', 'CGRtools.algorithms.tautomers',
