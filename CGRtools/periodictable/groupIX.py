...
class Co(Element, PeriodIV, GroupIX):
    ...
    def isotopes_distribution(self):
        return FrozenDict({59: 1.0})

    @property
    def isotopes_masses(self):
        return FrozenDict({59: 58.9332})
...
class Rh(Element, PeriodV, GroupIX):
    ...
    @property
    def isotopes_distribution(self):
        return FrozenDict({103: 1.0})

    @property
    def isotopes_masses(self):
        return FrozenDict({103: 102.905504})
...
class Ir(Element, PeriodVI, GroupIX):
    ...
    @property
    def isotopes_distribution(self):
        return FrozenDict({191: 0.373, 193: 0.627})

    @property
    def isotopes_masses(self):
        return FrozenDict({191: 190.960591, 193: 192.962924})
