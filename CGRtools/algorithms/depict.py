...
class DepictMolecule(Depict):
    ...
    def _render_atoms(self):
        ...
        if self._cumulenes((6, 7, 8)):
            cumulenes = {y for x in self._cumulenes(atoms_numbers=(6, 7, 8)) for y in x[1:-1] if len(x) > 2}
...
class DepictQuery(Depict):
    ...
    def _render_atoms(self):
        ...
        cumulenes = {}
        if self._cumulenes((6, 7, 8)):
            cumulenes = {y for x in self._cumulenes((6, 7, 8)) for y in x[1:-1] if len(x) > 2}
